_base_ = [
    '../multispec/yolox_csp_lwir_kaist.py'
]
# model settings
...
distiller = dict(
    ...
    teacher_pretrained = 'work_dirs/yolox_csp_kaist_2nc/epoch_10.pth',
    init_student = False,
    yolox = False,
...
student_cfg = 'configs/multispec/yolox_csp_lwir_kaist.py'
teacher_cfg = 'configs/multispec/yolox_csp_kaist_2nc.py'
