...
data_root = '/dataset/llvip_coco/'  #数据集的根路径
img_norm_cfg = dict(
...
train_dataset = dict(
    ...
    dataset=dict(
        type='KaistDataset',
        ann_file='/dataset/llvip_coco/annotations/train.json',
        img_prefix='/dataset/llvip_coco/train/',
        pipeline=[
...
data = dict(
    ...
    val = dict(
        ...
        ann_file='/dataset/llvip_coco/annotations/val.json',
        img_prefix='/dataset/llvip_coco/val/',
