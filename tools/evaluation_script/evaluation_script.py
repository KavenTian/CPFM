...
if __name__ == "__main__":
    ...
    parser.add_argument('--annFile', type=str, default='tools/evaluation_script/KAIST_annotation.json',
    ...
    parser.add_argument('--evalFig', type=str, default='KAIST_BENCHMARK.jpg',
